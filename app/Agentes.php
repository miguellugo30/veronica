...
class Agentes extends  Authenticatable
{
    ...
    {
        return $this->belongsToMany('App\Grupos', 'Grupos_Agentes');
    }
    /**
    ...
    {
        return $this->hasOne('App\Cat_Estado_Agente', 'id', 'Cat_Estado_Agente_id');
    }
    /**
    ...
    {
        return $this->belongsTo('App\Miembros_Campana', 'id', 'Agentes_id');
    }
    /**
     * Uno a muchos con Grupos_Agentes
     */
    ...
    {
        return $this->hasMany('App\Crd_Asignacion_Agente');
    }
    /**
    ...
    {
        return $this->hasMany('App\Registros_Eventos_Agentes', 'Agentes_id', 'id');
    }
    /**
    ...
    {
        return $this->hasMany('App\Perfiles', 'id', 'id_perfil_marcacion');
    }
    /**
    ...
    {
        return $this->hasMany('App\HistorialEventosAgentes', 'fk_agentes_id', 'id');
    }
    /**
    ...
    {
        return $this->hasOne('App\CanalAgentes', 'fk_agentes_id', 'id');
    }
