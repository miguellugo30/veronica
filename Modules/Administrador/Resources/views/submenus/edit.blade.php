<div class="col-md-6" style="float:none; margin:auto">
    <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="nombre" placeholder="Nombre" value="{{ $subCategoria->nombre }}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="descripcion" placeholder="Descripcion" value="{{ $subCategoria->descripcion }}">
    </div>
    <div class="form-group">
...
<div class="col-md-6" style="float:none; margin:auto">
    ...
    <div class="col-md-6" style="text-align:right">
        <button type="submit" class="btn btn-primary btn-sm editSubMenu"><i class="fas fa-save"></i> Guardar</button>
    </div>
</div>
