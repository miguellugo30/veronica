    ...
    <form enctype="multipart/form-data" id="editardistribuidores" method="post">
        ...
        <div class="form-group">
            <div class="text-center">
                <img src="{{ Storage::url($distribuidor->img_header)}}" id='image_input_header' class="rounded"/></label>
            </div>
        ...
        <div class="form-group ">
            <div class="text-center">
                <img src="{{ Storage::url($distribuidor->img_pie)}}" id='image_input_pie' class="rounded"/></label>
            </div>
            <div class="custom-file">
