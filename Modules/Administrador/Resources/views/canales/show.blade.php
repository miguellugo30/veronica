...
@foreach ($canales as $canal)
    <div class="col-md-12 canal{{$canal->id}}" style="text-align:center;border:grey 1px solid;">
        ...
        <br>
        <div class="col-md-1">
            <input type="checkbox" id="checkcanal{{$canal->id}}" name="checkcanal{{$canal->id}}" value="{{$canal->id}}" checked>
        </div>
    ...
    <? $canales.= $canal->id;?>
@endforeach
<input type="text" name="canal_empresa{{$canal->id}}" id="canal_empresa{{$canal->id}}" value="{{$canales}}">
</div>
