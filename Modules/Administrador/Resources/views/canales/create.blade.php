    ...
    <table  class="table table-striped tableNewCanal">
        <thead>
            <tr>
                ...
                <th>Troncal</th>
                <th>Prefijo</th>
                <td><input type="button" class="btn btn-primary btn-xs" id = "add" value = "Agregar canal" /></td>
            </tr>
        </thead>
        <tbody>
            <tr id="tr_1">
                <td>
                    <select name="tipo_canal_1" id="tipo_canal" class="form-control  input-sm tipo_canal" data-pos="1">
                ...
                <td>
                    <select name="Troncales_id_canal_1" id="Troncales_id_canal_1" class="form-control Troncales_id_canal  input-sm" >
