<div class="col-md-6" style="float:none; margin:auto">
    <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="nombre" placeholder="Nombre" value="{{ $cat_cliente->nombre }}">
        <input type="hidden" name="id" id="id" value="{{ $id }}">
        @csrf
    </div>
    <div class="form-group">
        <label for="email">Descripción</label>
        <input type="text" class="form-control input-sm" id="descripcion" placeholder="Descripcion" value="{{ $cat_cliente->descripcion }}">
    </div>
    <div class="form-group">
...
<div class="col-md-6" style="float:none; margin:auto">
    ...
    <div class="col-md-6" style="text-align:right">
        <button type="submit" class="btn btn-primary btn-sm updateEdoCli"><i class="fas fa-save"></i> Guardar</button>
    </div>
</div>
