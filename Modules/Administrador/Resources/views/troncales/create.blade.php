<div class="col-md-6" style="float:none; margin:auto">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="nombre" placeholder="Nombre" required>
        @csrf
    </div>
    <div class="form-group">
        <label for="nombre">Descripci&oacute;n</label>
        <input type="text" class="form-control input-sm" id="descripcion" placeholder="Descripcion" required>
    </div>
    <div class="form-group">
...
<div class="col-md-12">
    <div class="col-md-6" style="float:none; margin:auto">
        ...
        <div class="col-md-6" style="text-align:right">
            <button type="submit" class="btn btn-primary btn-sm saveTroncal"><i class="fas fa-save"></i> Guardar</button>
        </div>
    </div>
</div>
