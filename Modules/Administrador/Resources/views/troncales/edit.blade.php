<div class="col-md-6" style="float:none; margin:auto">
    <div class="form-group">
        ...
        <select name="distribuidores" id="distribuidores" class="form-control input-sm">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="nombre" placeholder="Nombre" value="{{ $troncal->nombre }}">
        <input type="hidden" name="id" id="id" value="{{ $troncal->id }}">
        @csrf
    </div>
    <div class="form-group">
        <label for="descripcion">Descripci&oacute;n</label>
        <input type="text" class="form-control input-sm" id="descripcion" placeholder="descripcion" value="{{ $troncal->descripcion }}">
    </div>
    <div class="form-group">
        <label for="ip_media">IP Media</label>
        <select name="ip_media" id="ip_media" class="form-control input-sm">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="ip_host" placeholder="IP Host" value="{{ $troncal->ip_host }}">
    </div>
</div>
<div class="col-md-12">
    <div class="col-md-6" style="float:none; margin:auto">
        ...
        <div class="col-md-6" style="text-align:right">
            <button type="submit" class="btn btn-primary btn-sm updateTrocal"><i class="fas fa-save"></i> Guardar</button>
        </div>
    </div>
</div>
