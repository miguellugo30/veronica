...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            @can('delete eventos')
            <button type="button" class="btn btn-danger  btn-sm deleteBaseDatos" style="display:none"><i class="fas fa-trash-alt"></i> Elminar</button>
            @endcan
            @can('edit eventos')
            <button type="button" class="btn btn-warning  btn-sm editBaseDatos" style="display:none"><i class="fas fa-edit"></i> Editar</button>
            @endcan
                @can('create eventos')
