<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title"><b><i class="fas fa-phone"></i> Formularios</b></h3>
    ...
    <div class="card-body">
        <div class="col-md-12 viewIndex">
            <table id="tableFormulario" class="display table table-bordered table-striped table-hover table-sm" style="width:100%">
