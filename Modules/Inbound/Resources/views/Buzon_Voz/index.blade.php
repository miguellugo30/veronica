<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title"><b><i class="fas fa-microphone-alt"></i> Buzon De Voz</b></h3>
    ...
    <div class="card-body">
        <div class="col-md-12 viewIndex">
            <table id="tableBuzonVoz" class="display  table table-bordered table-striped table-hover table-sm" style="width:100%">
