<div class="col">
    <table id='condicion' class="table table-striped table-sm tableeditForm">
        <thead>
            <tr>
            <th>Nombre</th>
        ...
        <tbody>
            <tr id="tr_1">
                ...
                <select name="mensaje_bienvenida_id" id="mensaje_bienvenida_id" class="form-control form-control-sm">
                    ...
                    <option value="{{$audio->id}}" {{$ivr->mensaje_bienvenida_id == $audio->id ? selected = "selected" : ''  }}>{{$audio->nombre}}</option>
                    @endforeach
                </select>                    
                </td>
                <td>
