        ...
        <table id='condicion' class="table table-striped table-sm tableNewForm">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control form-control-sm" id="tiempo_espera" name="tiempo_espera" value="" placeholder="En segundos">
                    </td>
                    <td>
            ...
            <table id="tableOpcionesIvr" class="table table-striped table-sm tableOpciones">
                ...
                <tbody>
                    <tr id="tr_1">
                        ...
                        <td>
                            <input type="number" name="digito_1" id="digito" class="form-control form-control-sm" min="1" placeholder="Dígito">
                        </td>
                        <td>
