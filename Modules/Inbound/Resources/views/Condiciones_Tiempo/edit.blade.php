                    ...
                    <tbody>
                        @for ( $i = 0; $i < count( $condiciones ); $i++)
                            <tr id="tr_{{ $condiciones[$i][0] }}" class="clonar">
                                ...
                                <td>
                                    <input type="text" class="form-control form-control-sm hora_inicio" size="6" name="hora_inicio_{{ $condiciones[$i][0] }}" id="hora_inicio" placeholder="hora_inicio" value="{{ $condiciones[$i][2] }}">
                                </td>
                                <td>
                                        <input type="text" class="form-control form-control-sm hora_fin" size="6" name="hora_fin_{{ $condiciones[$i][0] }}" id="hora_fin" placeholder="hora_fin" value="{{ $condiciones[$i][3] }}">
                                    </td>
                                    <td>
